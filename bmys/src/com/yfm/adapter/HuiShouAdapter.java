...
public class HuiShouAdapter extends LbAdapter {

	private Context context;
	private Dialog dialog;
	public static  String url="/MobApp/huishoulist";
	public static  String aurl="/MobApp/addhuishou";
	public static  String xxurl="/mobapp/Gethuishou/";
	public HuiShouAdapter(Context context){
	...
	public View getView(int arg0, View view, ViewGroup arg2) {
		// TODO Auto-generated method stub
		view=LayoutInflater.from(context).inflate(R.layout.huishou_item, null);
	...
	public Handler handler=new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			if(msg.what==0){
				HuiShouAdapter.this.notifyDataSetChanged();
				currpage++;
				isrun=false;
			}else{
