...
public class PartyAdapter extends LbAdapter {

	private Context context;
	private Dialog dialog;
	public static  String url="/MobApp/ClubList";
	public static  String aurl="/MobApp/AddClub";
	public static  String xxurl="/mobapp/GetClub/";
	...
	public View getView(int arg0, View view, ViewGroup arg2) {
		// TODO Auto-generated method stub
		view=LayoutInflater.from(context).inflate(R.layout.party_item, null);
