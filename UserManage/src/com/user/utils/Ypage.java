...
public class Ypage extends SimpleTagSupport
{
  ...
  public void doTag() throws JspException, IOException
  {
    ...
    sb.append("去第<input type=\"text\"  id=\"ygopage\" style='width:30px' value='"+cpage+"'>页");
    sb.append("<button style=\"margin: 0px;\" onclick=\"if(ygopage.value==parseInt(ygopage.value)&&parseInt(ygopage.value)>0){if(parseInt(ygopage.value)>="+total+"){gopage('"+total+"')}else{gopage(parseInt(ygopage.value))}}else{alert('请输入正整数！！')};\">确定</button>");
