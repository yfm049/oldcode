	...
	<head>
		...
		<script type="text/javascript">
			...
			function save(){
				...
				$.getJSON("<%=basePath%>/manager/user!adduser.action",{'user.username':username,'user.password':password,'user.realname':realname,'user.phonenum':phonenum,'user.email':email,'user.imei':imei,'user.time':time},function(msg){
					alert(msg.msg);
					if(msg.msg=='添加成功'){
						window.open("<%=basePath%>/manager/user!list.action","_self");
					}
