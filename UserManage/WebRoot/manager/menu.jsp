				...
				<td valign=top align=middle>
					...
					<table id=child1 style="display: block" cellspacing=0 cellpadding=0
						...
						<tr height=20>
							...
							<td>
								<a class=menuchild href="manager/user!list.action" target=main>浏览手机</a>
							</td>
						</tr>
						<tr height=20>
							<td align=middle width=30>
							...
							<td>
								<a class=menuchild href="manager/manage!list.action" target=main>管理手机</a>
							</td>
						</tr>
						<tr height=20>
							<td align=middle width=30>
							...
							<td>
								<a class=menuchild href="manager/user!loginlog.action" target=main>登陆记录</a>
							</td>
						</tr>
						<tr height=4>
							<td colspan=2></td>
