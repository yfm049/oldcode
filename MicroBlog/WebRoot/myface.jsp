		...
		<table border="0" align="center" cellpadding="0" cellspacing="0"
			...
			<tr>
				<td width="670" valign="top">
					<form action="servlet/FileUploadServlet?u_id=${sessionScope.user.u_id}" method="post"
						...
						<table border="0" align="center" cellpadding="0" cellspacing="0"
							...
							<tr>
								<td class="title">个人资料 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <a href = "login.jsp">返回登录</a></td>
							</tr>
							<tr>
								<td class="menu">
									<a href="userinfo.jsp">基本资料</a> |
									<a href="mypassword.jsp">修改密码</a> | 修改头像 | 
								</td>
							</tr>
							<tr>
								<td align="center">
									<table width="90%" border="0" cellpadding="5" cellspacing="0"
										...
										<tr>
											<td width="20%" align="center">
												<img src="${sessionScope.user.u_pic }" width="120"
													height="120" />
											</td>
											<td width="53%">
												<p>
