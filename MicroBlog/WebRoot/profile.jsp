					...
					<table id="welcome" border="0" cellspacing="0" cellpadding="0">
						<tr>
							<td width="30" height="30" rowspan="2" class="userface_bg">
								<img src="${sessionScope.user.u_pic}" border="0" width="45"
									height="45" />
							</td>
							<td><font size="3px" color="black">
								欢迎您，${sessionScope.user.u_nickname }</font>
							</td>
...
setInterval('refreshCalendarClock()',1000);
						...
						<tr>
							<td>
								<a href="servlet/RemoveSessionServlet"> <font size="3px">退出 </font> </a>
							</td>
						</tr>
					</table>
				</td>
				...
				<td width="670" height="600" valign="top">
									...
									<tr>
										<td>
											<p>
												...
												<br />
												<a
													href="/MicroBlog/servlet/GetuserServlet?u_id=${sessionScope.user.u_id }">修改个人信息</a>
					...
					<table id="weibo" width="90%" border="0" align="center"
						...
						<%
							...
							int u_id5 = user5.getU_id();// 拿到u_id
							...
							ResultSet rs = dbConn.execQuery(sql, new Object[] { u_id5 });
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0"
									...
									<tr>
										...
										<td align="right">
											...
											<a
												href="servlet/RemoveBlogServlet?w_id=<%=rs.getString("w_id")%>&w_content=<%=rs.getString("id")%>"
												style="text-decoration: none">删除</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<a
												href="servlet/ShowMyCommentServlet?c_id=<%=rs.getString("id")%>"
					...
					<table align="center" id="page">
						<tr>
							...
							%>
								&nbsp; &nbsp;
								<a href="profile.jsp?page=<%=intPage - 1%>">上一页</a>
								<%
									}
									if (intPage < intPageCount) {
								%>
								<a href="profile.jsp?page=<%=intPage + 1%>">下一页</a>
							</td>
							<%
								}
								rs.close();
        ...
        <div>
         <%if(intPage1<intPageCount1){ %>
            <a href ="profile.jsp" class="huanyihuan " style="text-decoration: none"><font color="black"> 换一换</font></a>
             <%
          }
         rs1.close();
