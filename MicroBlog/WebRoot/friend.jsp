...
setInterval('refreshCalendarClock()',1000);
        ...
        <tr>
          <td><a href="servlet/RemoveSessionServlet"><font size="3px">退出</font> </a></td>
        </tr>
      </table>
    </td>
  </tr>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="menu">
        ...
        <!-- weibo 开始-->
   <c:forEach items="${friendlist}" var="obj3" >  
          ...
          <tr>
            <td colspan="2"><table border="0" cellpadding="0" cellspacing="0" class="userdetail">
              ...
              <!-- 记录被修改输的标识 -->
                ...
                <td width="26%">
                <a href="servlet/ShowUserServlet?u_id=${obj3.u_id}"><img src="${obj3.u_pic}" width="50" height="50" border="0" /></a></td>
                <td width="74%">
                
               <a href="servlet/ShowUserServlet?u_id=${obj3.u_id}">${obj3.u_nickname}</a> 
               <input name="" type="submit" class="btnguanzhu" id="" value="取消关注" />
                <br />
               ${obj3.u_city}<br />生日：${obj3.u_date}</td>
              </tr>
            </table></td>
          </tr>
              </table>
    ...
    <!-- weibo 结束-->
	  ...
	  pageContext.setAttribute("looklist",looklist); 
       ...
       <table border="0" align="center" cellpadding="0" cellspacing="0" id="userlist">
        ...
        <div>
         <%if(intPage1<intPageCount1){ %>
            <a href ="friend.jsp" class="huanyihuan " style="text-decoration: none"><font color="black"> 换一换</font></a>
             <%
          }
         rs1.close();
