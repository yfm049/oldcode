  ...
  <tr>
    ...
    <td width="25%" align="right">
      <table id="welcome" border="0" cellspacing="0" cellpadding="0">
        <tr>          
          <td width="30" height="30" rowspan="2" class="userface_bg"><img src="${sessionScope.user.u_pic}" border="0" width="47" height="47" style="height: 47px;"/></td>
  ...
  <tr>
    <td width="670" height="600" valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" id="curruser">
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="menu">
        ...
        <!-- weibo 开始-->
         <%	
	  ArrayList<Weibo> alllist=(ArrayList<Weibo>)session.getAttribute("alllist"); 
	  pageContext.setAttribute("alllist",alllist); 
        ...
        <table id="weibo" width="90%" border="0" align="center" cellpadding="3" cellspacing="0">
          <tr>
            <td width="88%" class="content"> ${obj.w_content}</td>
          </tr>
          <tr>
            <td height="74">
              <label>
    ...
    <!-- weibo 结束-->
        ...
        <table align="center" id="userinfo">
          <tr>
            <td width="25%" rowspan="2"><img src="${sessionScope.user.u_pic}" width="50" height="50" class="userphoto" /></td>
            <td width="75%"><a href="profile.jsp">${sessionScope.user.u_nickname}</a></td>
          </tr>
          <tr>
        ...
        <div>
         <%if(intPage1<intPageCount1){ %>
            <a href ="user.jsp" class="huanyihuan " style="text-decoration: none"><font color="black"> 换一换</font></a>
             <%
          }
         rs1.close();
