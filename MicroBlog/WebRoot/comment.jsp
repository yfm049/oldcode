  ...
  <tr>
    ...
    <td width="25%" align="right">
      <table id="welcome" border="0" cellspacing="0" cellpadding="0">
        <tr>          
          <td width="30" height="30" rowspan="2" class="userface_bg"><img src="${sessionScope.user.u_pic}" border="0" width="48" height="48"/></td>
...
<table border="0" align="center" cellpadding="0" cellspacing="0" id="container">
  <tr>
    <td width="670" height="600" valign="top"><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0" id="curruser">
      <tr>
        <td width="24%"><img src="${sessionScope.user.u_pic}" width="120" height="120" class="userphoto" /></td>
        <td width="76%" valign="top"><table width="100%" border="0" cellpadding="0" cellspacing="0" id="curruserdetail">
          <tr>
            <td class="title">${sessionScope.user.u_nickname}</td>
          </tr>
          <tr>
            <td><p><a href="#">http://weibo.com/ada<br />
              </a>${sessionScope.user.u_city}<br />
            签名：${sessionScope.user.u_motto}<br />
            <a href="#">+添加关注</a></p></td>
          </tr>
        </table></td>
      </tr>
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="menu">
        ...
        <!-- weibo 开始-->
         <%	
	  ArrayList<Comment> alllist=(ArrayList<Comment>)request.getAttribute("alllist"); 
	  pageContext.setAttribute("alllist",alllist); 
	  
 
        %>
       
					<form  action="servlet/CommentServlet">
					<input type="hidden" name="c_id" value="${obj.w_id}">
                <input type="hidden" name="id" value="${obj.id}">
            <input type="hidden" name="c_uid" value="${sessionScope.user.u_id}">
             <input type="hidden" name="c_unick" value="${sessionScope.user.u_nickname}">
             <input type="hidden" name="c_upic" value="${sessionScope.user.u_pic}">
        ...
        <table id="weibo" width="90%" border="0" align="center" cellpadding="3" cellspacing="0">
          ...
          <tr>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" id="weibo_status">
              <tr> <br/> 
                <td height="56"><table width="595" border="0" cellpadding="0">
                  <tr>
                    <td width="93" height="47" valign="top" align="right" rowspan="3"><font size="3"><img width="50" height="50" src="${obj.c_upic}" /></font></td>
                    <td width="496" height="58" ><font size="3">${obj.c_unick}<a href="user.jsp"></a> 
<img align="middle" width="11" height="10" src="icon/v.gif" /> </font><font color="#000000" size="3">
： ${obj.c_content}</font></td>
                  </tr>
                  <tr> 
                    <td height="45" ><br /></td>
                    <td>&nbsp;</td>
                  ...
                  <tr>
                    <td height="49"><table width="505" border="0" cellpadding="0">
                      <tr>
                        <td height="62">${obj.c_date}</td>
                        <td align="right">共${sessionScope.num }条评论&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="servlet/RemoveCommentServlet?id=${obj.id}&c_id=${obj.c_id}">删除</a></td>
                      </tr>
                    </table></td>
                    <td height="25">&nbsp;</td>
                  </tr>
    ...
    <!-- weibo 结束-->
        ...
        <table align="center" id="userinfo">
          <tr>
            ...
            <td width="75%"><a href="profile.html">${sessionScope.user.u_nickname}</a></td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="2" align="left"><table width="80%" border="0" align="left" cellpadding="3" cellspacing="0">
              <tr>
                <td align="center" class="split2"><a href="servlet/AttentionSevlet?u_id=${sessionScope.user.u_id}">关注</a><br>${sessionScope.ConcersNum}</td>
                <td align="center" class="split2"><a href="servlet/FansServlet?u_id=${sessionScope.user.u_id}">粉丝</a><br>
${sessionScope.FansNum}</td>
       ...
       <table border="0" align="center" cellpadding="0" cellspacing="0" id="userlist">
        ...
        <div>
         <%if(intPage1<intPageCount1){ %>
            <a href ="comment.jsp" class="huanyihuan " style="text-decoration: none"><font color="black"> 换一换</font></a>
             <%
          }
         rs1.close();
