...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" id="menu">
     ...
     <%   
          ...
          User	user2=(User)session.getAttribute("user");
				int u_id2 = user2.getU_id();// 拿到u_id
        ...
        // out.print(u_id123+"--------------------------------");
		  ...
		  ResultSet rs = dbConn.execQuery(sql, new Object[]{ u_id2,u_id2 });
          ...
          %>
      		...
      		<form action="servlet/ZhuanfaServlet"> <input type="hidden" id="" name="zhuanw_content" value="${obj.w_content}" />
			<input type="hidden" id="" name="zhuanw_date" value="${obj.w_date}" />
			<input type="hidden" id="" name="zhuanw_id" value="${sessionScope.user.u_id}" />
			<input type="hidden" id="" name="zhuanw_unick" value="${sessionScope.user.u_nickname}" />
			<input type="hidden" id="" name="zhuanw_upic" value="${sessionScope.user.u_pic}" />
			
			<input name="dosubmit" type="submit" id="dosubmit" value="" style="background:url(images/zhuanfa.png); border-style:none; width:28px; height:22px; background-repeat:no-repeat;" />(10)&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;收藏&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;评论</form>
      ...
      <%
       ...
       if(intPage<intPageCount){%>
        <a href ="allweibo.jsp?page=<%=intPage+1 %>">下一页</a></td>
       <%
       }
      rs.close();
      dbConn.closeConn();
  	...
  	<table border="0" align="center" cellpadding="0" cellspacing="0" id="userlist">
        ...
        <div>
         <%if(intPage1<intPageCount1){ %>
            <a href ="allweibo.jsp" class="huanyihuan " style="text-decoration: none"><font color="black"> 换一换</font></a>
             <%
          }
         rs1.close();
